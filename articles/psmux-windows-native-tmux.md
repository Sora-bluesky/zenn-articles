---
title: "WSLなしでWindowsにtmuxを：Rust製psmuxでペイン分割とAIエージェント並列実行"
emoji: "🖥️"
type: "tech"
...
| 項目 | 内容 |
|------|------|
| リポジトリ | [github.com/marlocarlo/psmux](https://github.com/marlocarlo/psmux) |
| 言語 | Rust |
| ライセンス | MIT |
...
:::message
**公式ドキュメント**
- [psmux 公式リポジトリ](https://github.com/marlocarlo/psmux) -- インストール方法、設定リファレンス、全コマンド一覧
