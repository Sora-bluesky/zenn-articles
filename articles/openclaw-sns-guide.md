...
:::message alert
v2026.2.13以降、パブリックIPからのアクセスにBearer Tokenが必須になった。ngrok経由でもBearer Token認証を設定すること。詳細は[OpenClaw Authentication](https://docs.openclaw.ai/gateway/authentication)を参照。
:::
