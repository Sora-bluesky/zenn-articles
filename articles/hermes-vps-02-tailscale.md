---
title: "【第2回】Hermes Agentの公開SSHをTailscaleで安全に閉じる"
emoji: "🔒"
type: "tech"
...
- [はじめに](#はじめに)
- [第1回と第2回の差分](#第1回と第2回の差分)
- [そもそもTailscaleとは](#そもそもtailscaleとは)
- [構成の全体像(第2回終了時点)](#構成の全体像(第2回終了時点))
- [事前準備──命綱の確保と1Passwordアイテム](#事前準備──命綱の確保と1passwordアイテム)
- [1. VPSにTailscaleを入れてTailnetに参加させる](#1.-vpsにtailscaleを入れてtailnetに参加させる)
- [2. 手元PCにもTailscaleを入れる](#2.-手元pcにもtailscaleを入れる)
- [3. Tailscale経由でadminログイン確認(最重要)](#3.-tailscale経由でadminログイン確認(最重要))
- [4. 公開22番を二重に閉じる](#4.-公開22番を二重に閉じる)
- [5. 最終確認とTailscaleキー無期限化](#5.-最終確認とtailscaleキー無期限化)
- [つまずき集](#つまずき集)
- [まとめ](#まとめ)
