...
- [第7回](https://zenn.dev/sora_biz/articles/hermes-vps-07-desktop)──Hermes Agentをマウス操作で動かす──公式アプリ「Hermes Desktop」を入れる
- **第8回**(本記事)──Hermes Agentをブラウザの管制室から操る──Web Dashboardで設定を見える化する
- [第9回](https://zenn.dev/sora_biz/articles/hermes-vps-09-cron)──Hermes Agentが朝から話しかけてくる──Dashboardで毎朝の定型タスクを任せる
...
| ← 前の回 | 次の回 → |
|---|---|
| [第7回 Hermes Desktopを入れる](https://zenn.dev/sora_biz/articles/hermes-vps-07-desktop) | [第9回 Dashboardで毎朝の定型を任せる](https://zenn.dev/sora_biz/articles/hermes-vps-09-cron) |
