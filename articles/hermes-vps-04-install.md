...
| ← 前の回 | 次の回 → |
|---|---|
| [第3回 パスワードを一切書くな。Hermes Agentの秘密は1Passwordが預かる。](https://zenn.dev/sora_biz/articles/hermes-vps-03-1password) | [第5回 コマンドを覚えるな。Hermes AgentはDiscordで話しかけるだけで動く。](https://zenn.dev/sora_biz/articles/hermes-vps-05-oauth-discord) |
