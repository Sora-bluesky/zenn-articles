...
| ← 前の回 | 次の回 → |
|---|---|
| [第11回 新聞は自分で読むな。Hermes Agentは毎朝7時に朝刊を用意する。](https://zenn.dev/sora_biz/articles/hermes-vps-11-web-search) | [第13回 メモを自分で探すな。Hermes AgentはObsidianを記憶として読む。](https://zenn.dev/sora_biz/articles/hermes-vps-13-obsidian) |
