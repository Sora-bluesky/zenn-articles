...
| 有料アカウントにしたら戻せる？ | **戻せない。** 不要になったら[請求先アカウントを閉鎖する](/articles/google-cloud-billing-check) |
...
2. 「有料のアカウント」と表示されていて不要なら → [課金管理の記事](/articles/google-cloud-billing-check)で止め方を確認
3. Gemini API で画像生成をしたい場合 → [画像生成の記事](/articles/gemini-api-image-generation-guide)で料金やモデルを確認
