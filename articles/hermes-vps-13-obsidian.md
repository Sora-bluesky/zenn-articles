...
![Hermes Agentの内蔵メモリ(三層=Markdown/SQLite/外部provider)とObsidian Vault(外付け脳・母艦ローカル)が、bundled obsidian skill+OBSIDIAN_VAULT_PATH環境変数を介して役割分担する構成図](/images/hermes-vps/hermes-vps-13-obsidian-architecture-diagram.png)
