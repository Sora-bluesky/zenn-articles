...
ちなみに、この読みやすさを救ってくれたのは、ずんだもんである。どういうことか、これから書く。コード・導入手順はリポジトリ [`Sora-bluesky/codex-jp-harness`](https://github.com/Sora-bluesky/codex-jp-harness) に置いてあるので、本文では概念と判断の部分だけに絞る。
...
中身は FastMCP で書いた `finalize(draft)` ツール 1 つ。検品ロジックで効いた判断だけ書いておく。
...
詳しい挙動は [Release v0.2.0](https://github.com/Sora-bluesky/codex-jp-harness/releases/tag/v0.2.0) / [v0.2.1](https://github.com/Sora-bluesky/codex-jp-harness/releases/tag/v0.2.1) / [v0.2.2](https://github.com/Sora-bluesky/codex-jp-harness/releases/tag/v0.2.2) / [v0.2.3](https://github.com/Sora-bluesky/codex-jp-harness/releases/tag/v0.2.3) / [v0.2.4](https://github.com/Sora-bluesky/codex-jp-harness/releases/tag/v0.2.4) のリリースノートを参照。
...
試したくなったら [`Sora-bluesky/codex-jp-harness`](https://github.com/Sora-bluesky/codex-jp-harness) へどうぞ。Windows / macOS / Linux（Git Bash on Windows 含む）のいずれでも、README の手順どおりに 1 分で入る。
