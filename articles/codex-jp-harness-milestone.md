...
詳しい挙動は [Release v0.2.0](https://github.com/Sora-bluesky/codex-jp-harness/releases/tag/v0.2.0) / [v0.2.1](https://github.com/Sora-bluesky/codex-jp-harness/releases/tag/v0.2.1) / [v0.2.2](https://github.com/Sora-bluesky/codex-jp-harness/releases/tag/v0.2.2) のリリースノートを参照。
