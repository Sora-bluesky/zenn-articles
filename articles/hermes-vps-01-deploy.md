---
title: "【第1回】サーバー代は月1,800円で足りる。Hermes AgentはVPSで24時間動き続ける"
emoji: "🤖"
type: "tech"
...
「これ、前にも頼んだはずなんだけどな」。AIに向かってそう思った瞬間はないだろうか。ChatGPTもClaudeも、聞けば賢く答えてくれる。けれど会話を切り替えれば、また一から事情を説明させられる。前に教えたやり方も、次の会話ではまた伝え直しになる。賢いはずなのに、こちらのやり方は一向に覚えてくれない。しかもパソコンを閉じれば止まるし、出先のスマホからは細切れにしか頼れない。もし、頼むほどに自分の手順を覚えて自分専用に育っていくAIがいて、それがパソコンを閉じても止まらず、出先のスマホからでも続きを頼めたら。
...
![シリアルコンソールに接続後、loginプロンプトにrootと入力したところ](/images/hermes-vps/hermes-vps-01-serial-login.png)
...
| ← 前の回 | 次の回 → |
|---|---|
| (これが第1回です) | [第2回 パスワードはもう打つな。Hermes AgentへのSSHは鍵一発で入れる](https://zenn.dev/sora_biz/articles/hermes-vps-02-tailscale) |
