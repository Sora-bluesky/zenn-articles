...
新規プロジェクトの場合は `git init` でリポジトリを作成する（[第 3 章](03-first-repository)参照）。

**参照**: [第 3 章](03-first-repository)
...
**参照**: [第 5 章](05-push-and-pull)、[第 9 章](09-troubleshooting)
...
**参照**: [第 6 章](06-branch-and-merge)、[第 9 章](09-troubleshooting)
...
SSH を使い続けたい場合は、[第 10 章の「SSH 接続」](10-next-steps)を参照。

**参照**: [第 5 章](05-push-and-pull)、[第 10 章](10-next-steps)
